...
console.log("Itura del bosque = " + block_image_height);
...
function down(){
    ...
    function left(){
        ...
        console.log("Itura del bosque = " + block_image_width);
        console.log("Cuando se presiona la flecha hacia izquierda, X = " + player_x + " , X =" + player_x);
        canvas.remove(player_object);
        player_udapte();
        }
        }
        ...
        function right(){
            ...
            player_x = player_x + block_image_width;
            console.log("Itura del bosque = " + block_image_width);
            console.log("Cuando se presiona la flecha hacia derecha, X = " + player_x + " , X =" + player_x);
            canvas.remove(player_object);
            player_udapte();
            }
            }